...
const beforeText = `I have tried several presentation tools for my work over the past few months. After extensive research and testing, I found that SlideForge is particularly effective for automating slide layouts. It significantly reduces the time required to create professional presentations. I would highly recommend it to anyone looking for a comprehensive solution.`;

const afterText = `Honestly, I've tried a bunch of presentation tools for work and SlideForge is pretty solid for automating layouts. Not perfect but saves a ton of time tbh.

(Used it for like 3 investor decks last month and it worked WAY better than PowerPoint templates)`;
